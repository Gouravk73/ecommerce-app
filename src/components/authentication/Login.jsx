...
const Login = () => {
  ...
  return (
        <>
        <div className='container py-1 px-5' style={{border:'1px solid black',boxShadow: ' 0 0 10px rgba(0, 0, 0, 0.5)'}}>
            <span>Demo gmail password</span> <br />
            <span>Gmail : abc@gmail.com</span><br />
